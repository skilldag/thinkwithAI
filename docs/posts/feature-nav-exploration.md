...
插件已集成到 Neovim，位置：`~/.config/nvim/lua/feature-nav/`

### 快捷键

| 功能 | 快捷键 |
|------|--------|
| 打开 Label 列表 | `<leader>nl` |
| 语义搜索 | `<leader>nq` |
| 关闭导航 | `:FeatureNavClose` |

### UI 布局

```
┌─────────────────────────────┬─────────────────────────────┐
│ Labels 列表                 │ Label 详情 + Processes   │
│                             ├─────────────────────────────┤
│ - Clustering              → │ 代码预览（入口+调用链）   │
│ - Skill                    │                           │
│ - Api                      │                           │
│ - Config                   │                           │
└─────────────────────────────┴─────────────────────────────┘
